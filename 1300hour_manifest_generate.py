...
train_manifest_list.extend(primewords_data.apply(lambda x: json.dumps({'audio_filepath':'{}/{}'.format(path_prefix, x[5]), 
                                                                       'duration':x[2],
                                                                       'text':x[3]}, ensure_ascii=False), axis=1))
...
train_manifest_list.extend(stcmd_data.apply(lambda x: json.dumps({'audio_filepath':'{}/{}'.format(path_prefix, x[2]), 
                                                                  'duration':x[3],
